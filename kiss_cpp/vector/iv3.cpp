...
constexpr iv3::iv3 (int all): x{all}, y{all}, z{all} {
	
}

constexpr iv3::iv3 (int x, int y, int z): x{x}, y{y}, z{z} {
	
}

constexpr iv3::iv3 (iv2 xy, int z): x{xy.x}, y{xy.y}, z{z} {
	
}

constexpr iv3::iv3 (iv4 v): x{v.x}, y{v.y}, z{v.z} {
