...
namespace vector {
	...
	f64 f64m3x4::get (int r, int c) const {
		return arr[c][r];
	}
	
	dv3 f64m3x4::get_column (int indx) const {
		return arr[indx];
	}
	
	dv4 f64m3x4::get_row (int indx) const {
	...
	f64m3x4 f64m3x4::rows (dv4 row0, dv4 row1, dv4 row2) {
		return f64m3x4(
	...
	f64m3x4 f64m3x4::columns (dv3 col0, dv3 col1, dv3 col2, dv3 col3) {
		return f64m3x4(
	...
	f64m3x4::operator f64m2 () {
		return f64m2(
				arr[0][0], arr[1][0],
				arr[0][1], arr[1][1]);
	}
	
	f64m3x4::operator f64m3 () {
		return f64m3(
	...
	f64m3x4::operator f64m2x3 () {
		return f64m2x3(
				arr[0][0], arr[1][0], arr[2][0],
				arr[0][1], arr[1][1], arr[2][1]);
	}
	
	f64m3x4::operator m3x4 () {
		return m3x4(
	...
	f64m3x4 f64m3x4::operator+ (f64m3x4 m) {
		return f64m3x4(
