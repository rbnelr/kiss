...
namespace vector {
	...
	f32 m3::get (int r, int c) const {
		return arr[c][r];
	}
	
	fv3 m3::get_column (int indx) const {
		return arr[indx];
	}
	
	fv3 m3::get_row (int indx) const {
	...
	m3 m3::rows (fv3 row0, fv3 row1, fv3 row2) {
		return m3(
	...
	m3 m3::columns (fv3 col0, fv3 col1, fv3 col2) {
		return m3(
